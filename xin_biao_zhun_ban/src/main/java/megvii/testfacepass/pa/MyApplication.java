...
public class MyApplication extends Application {
    ...
    private Box<DepartmentBean> departmentBeanBox=null;
    private Box<AttendanceBean> attendanceBeanBox=null;
   // private Box<FaceIDBean> faceIDBeanBox= null;
   // private Box<IDCardTakeBean> idCardTakeBeanBox=null;
  //  private Box<HuiFuBean> huiFuBeanBox = null;
    private Box<WeekDataBean> weekDataBeanBox = null;
    private Box<DaKaBean> daKaBeanBox = null;
  //  private Box<IDCardBean> idCardBeanBox = null;
    public static final String SDPATH = Environment.getExternalStorageDirectory().getAbsolutePath()+ File.separator+"ruitongbz1";
    public static final String SDPATH2 = Environment.getExternalStorageDirectory().getAbsolutePath()+File.separator+"ruitongbz2";
    public static final String SDPATH3 = Environment.getExternalStorageDirectory().getAbsolutePath()+File.separator+"ruitongbz3";
    public static final String SDPATH4 = Environment.getExternalStorageDirectory().getAbsolutePath()+File.separator+"ruitongbz4";
   // protected OutputStream mOutputStream;
    ...
    public void onCreate() {
        ...
        Bugly.init(this, "951359d25d", false);
...
//        startService(dialogservice);
        ...
        departmentBeanBox= mBoxStore.boxFor(DepartmentBean.class);
        attendanceBeanBox= mBoxStore.boxFor(AttendanceBean.class);
       // faceIDBeanBox= mBoxStore.boxFor(FaceIDBean.class);
      ...
      //  chengShiIDBeanBox= mBoxStore.boxFor(ChengShiIDBean.class);
        ...
        weekDataBeanBox= mBoxStore.boxFor(WeekDataBean.class);
...
//        customAdaptForExternal();
      ...
      ConfigBean configBean = kv.decodeParcelable("configBean",ConfigBean.class);
        if (configBean == null) {
            configBean = new ConfigBean();
            configBean.setHoutaiDiZhi("http://hy.inteyeligence.com/front");
            configBean.setTouxiangzhuji("http://open.inteyeligence.com:8080/front");
            configBean.setShibieFaceSize(30);
            configBean.setShibieFaZhi(72f);
            configBean.setRuKuFaceSize(70);
            configBean.setRuKuMoHuDu(0.6f);
            configBean.setHuoTiFZ(72);
            configBean.setMima(123456);
            configBean.setMima2(123456);
            configBean.setJihuoma("1266-3264-3886-6563-0724");
            configBean.setHuoTi(false);
            configBean.setDangqianChengShi2("");
            configBean.setPort(8090);
            configBean.setMsrPanDing(true);
            configBean.setConfigModel(4);
            configBean.setRetryCount(5);
            configBean.setJidianqi(5000);
            configBean.setLoginPassword("123456");
            configBean.setLowBrightnessThreshold(70);
            configBean.setHighBrightnessThreshold(210);
            configBean.setBrightnessSTDThreshold(82);
            configBean.setAddFaceBlurThreshold(0.3f);
            configBean.setMima(123456);
            configBean.setMqProt(5672);
            configBean.setMima2(123456);
            configBean.setTaskIntervalTime(1);
            configBean.setHeartbeatIntervalTime(1);
            configBean.setGpio(218);
            configBean.setOpenCard(true);//刷卡功能开启
            configBean.setNian(DateUtils.timesNian(System.currentTimeMillis()+""));
            configBean.setWeekDate("星期六,星期日");
            configBean.setWook1("9:00");
            configBean.setOffDuty1("18:00");
            configBean.setQueqing1(60);
            configBean.setQueqing2(60);
            configBean.setYouxiao1(30);
            configBean.setYouxiao2(30);

            DepartmentBean departmentBean=new DepartmentBean();
            departmentBean.setName("销售部");
            departmentBean.setSid(System.currentTimeMillis()+"");
            departmentBeanBox.put(departmentBean);
            kv.encode("configBean",configBean);
        }
 ...
 //   }
   ...
   // }
    ...
    public Box<DepartmentBean> getDepartmentBeanBox(){
        return departmentBeanBox;
    }
//
    public Box<WeekDataBean> getWeekDataBeanBox(){
        return weekDataBeanBox;
    }
    public Box<AttendanceBean> getAttendanceBeanBox(){
        return attendanceBeanBox;
    }
   // public Box<FaceIDBean> getFaceIDBeanBox(){
  //      return faceIDBeanBox;
 //   }
