 ...
 */
package megvii.testfacepass.pa.html.component;
...
import megvii.testfacepass.pa.html.util.JsonUtils;
...
public class LoggerInterceptor implements HandlerInterceptor {
    ...
    public boolean onIntercept(@NonNull HttpRequest request, @NonNull HttpResponse response,
       ...
       // Logger.i("AppExceptionResolverPath: " + path);
       // Logger.i("AppExceptionResolverMethod: " + method.value());
       // Logger.i("AppExceptionResolverParam: " + JsonUtils.toJsonString(valueMap));
        return false;
    }
}